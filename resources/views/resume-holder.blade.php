                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            ...
                            <tbody class="text-center">
                                    @foreach ($holder_position as $holderpos)
                                        <tr>
                                            <td class="text-xs font-weight-bold mb-0">{{ $holderpos->no_drawing }}</td>
                                            <td class="text-xs font-weight-bold mb-0">{{ $holderpos->qr_marking }}</td>
                                            <td class="text-xs font-weight-bold mb-0">{{ $holderpos->part_name }}</td>
                                            <td class="text-xs font-weight-bold mb-0">{{ $holderpos->pos_id}}</td>
                                            <td class="text-xs font-weight-bold mb-0">{{ $holderpos->pos_name}}</td>
                                        </tr>
                                        @endforeach
                            </tbody>
                        </table>
