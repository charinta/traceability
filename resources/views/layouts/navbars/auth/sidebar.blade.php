    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item mt-2">
            <a class="nav-link {{ Request::is('user-account') ? 'active' : '' }}" href="{{ url('user-account') }}">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg width="12px" height="12px" fill="#000000" width="248px" height="248px" viewBox="0 0 24 24"
        ...
        <li class="nav-item mt-2">
            <a class="nav-link {{ Request::is('register-line') ? 'active' : '' }}" href="{{ url('register-line') }}">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item mt-2">
            <a class="nav-link {{ Request::is('register-tool') ? 'active' : '' }}" href="{{ url('register-tool') }}">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item mt-2">
            <a class="nav-link {{ Request::is('shift') ? 'active' : '' }}" href="{{ url('shift') }}">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg width="12px" height="12px" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
